...
export class DrupalExtension {
  ...
  getStyleDestinations() {
    return [
      path.join(this.path, 'styles', '*.min.css'),
      path.join(this.path, 'styles', '*.css.map'),
  ...
  getScriptDestinations() {
    return [
      path.join(this.path, 'scripts', '*.min.js'),
      path.join(this.path, 'scripts', '*.js.map'),
...
export class ConfigBuilder {
  ...
  applyDefaults() {
    return this
      .addStyleIgnores([
        // Ignore "node_modules": Auto-generated by npm.
        '**/node_modules/**',
        // Ignore "vendor": 3rd-party libraries.
        '**/vendor/**',
